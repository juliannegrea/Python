...
# isalpha(): devuelve True si la cadena contiene solo letras, de lo contrario, devuelve False.
# isdigit(): devuelve True si la cadena contiene solo dígitos, de lo contrario, devuelve False.
# isalnum(): devuelve True si la cadena contiene solo letras y/o dígitos, de lo contrario, devuelve False.
# isspace(): devuelve True si la cadena contiene solo espacios en blanco, de lo contrario, devuelve False.
# startswith(prefix): devuelve True si la cadena comienza con el prefijo especificado, de lo contrario, devuelve False.
# endswith(suffix): devuelve True si la cadena termina con el sufijo
# especificado, de lo contrario, devuelve False.
